...
inline void to_json(json& j, const SavedSceneFlags& flags) {
    j = json{
        {"chest", flags.chest},
        {"swch", flags.swch},
        {"clear", flags.clear},
...
inline void from_json(const json& j, SavedSceneFlags& flags) {
...
inline void from_json(const json& j, SaveContext& saveContext) {
    ...
    j.at("questId").get_to(saveContext.questId);
}
