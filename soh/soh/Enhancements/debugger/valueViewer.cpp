...
void ValueViewerWindow::DrawElement() {
    ...
    if (ImGui::Button("S16##gPlayground.Int")) {
        CVarSetInteger("gPlayground.IntMin", SHRT_MIN);
        CVarSetInteger("gPlayground.IntMax", SHRT_MAX);
        Ship::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesNextFrame();
    }
    ImGui::SameLine();
    if (ImGui::Button("U16##gPlayground.Int")) {
        CVarSetInteger("gPlayground.IntMin", 0);
        CVarSetInteger("gPlayground.IntMax", USHRT_MAX);
        Ship::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesNextFrame();
    }
    ImGui::SameLine();
    if (ImGui::Button("S8##gPlayground.Int")) {
        CVarSetInteger("gPlayground.IntMin", CHAR_MIN);
        CVarSetInteger("gPlayground.IntMax", CHAR_MAX);
        Ship::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesNextFrame();
    }
    ImGui::SameLine();
    if (ImGui::Button("U8##gPlayground.Int")) {
        CVarSetInteger("gPlayground.IntMin", 0);
        CVarSetInteger("gPlayground.IntMax", UCHAR_MAX);
        Ship::Context::GetInstance()->GetWindow()->GetGui()->SaveConsoleVariablesNextFrame();
    }
    ...
    if (ImGui::SliderInt("##gPlayground.Int1X", &playgroundInt1X, playgroundIntMin, playgroundIntMax, "gPlayground.Int1X:%d")) {
    ...
    if (ImGui::SliderInt("##gPlayground.Int1Y", &playgroundInt1Y, playgroundIntMin, playgroundIntMax, "gPlayground.Int1Y:%d")) {
    ...
    if (ImGui::SliderInt("##gPlayground.Int1Z", &playgroundInt1Z, playgroundIntMin, playgroundIntMax, "gPlayground.Int1Z:%d")) {
    ...
    if (ImGui::SliderInt("##gPlayground.Int2X", &playgroundInt2X, playgroundIntMin, playgroundIntMax, "gPlayground.Int2X:%d")) {
    ...
    if (ImGui::SliderInt("##gPlayground.Int2Y", &playgroundInt2Y, playgroundIntMin, playgroundIntMax, "gPlayground.Int2Y:%d")) {
    ...
    if (ImGui::SliderInt("##gPlayground.Int2Z", &playgroundInt2Z, playgroundIntMin, playgroundIntMax, "gPlayground.Int2Z:%d")) {
    ...
    if (ImGui::SliderFloat("##gPlayground.Float1X", &playgroundFloat1X, playgroundFloatMin, playgroundFloatMax, "gPlayground.Float1X:%f")) {
    ...
    if (ImGui::SliderFloat("##gPlayground.Float1Y", &playgroundFloat1Y, playgroundFloatMin, playgroundFloatMax, "gPlayground.Float1Y:%f")) {
    ...
    if (ImGui::SliderFloat("##gPlayground.Float1Z", &playgroundFloat1Z, playgroundFloatMin, playgroundFloatMax, "gPlayground.Float1Z:%f")) {
    ...
    if (ImGui::SliderFloat("##gPlayground.Float2X", &playgroundFloat2X, playgroundFloatMin, playgroundFloatMax, "gPlayground.Float2X:%f")) {
    ...
    if (ImGui::SliderFloat("##gPlayground.Float2Y", &playgroundFloat2Y, playgroundFloatMin, playgroundFloatMax, "gPlayground.Float2Y:%f")) {
    ...
    if (ImGui::SliderFloat("##gPlayground.Float2Z", &playgroundFloat2Z, playgroundFloatMin, playgroundFloatMax, "gPlayground.Float2Z:%f")) {
    ...
    if (ImGui::SliderFloat("##gPlayground.Float3X", &playgroundFloat3X, playgroundFloatMin, playgroundFloatMax, "gPlayground.Float3X:%f")) {
    ...
    if (ImGui::SliderFloat("##gPlayground.Float3Y", &playgroundFloat3Y, playgroundFloatMin, playgroundFloatMax, "gPlayground.Float3Y:%f")) {
    ...
    if (ImGui::SliderFloat("##gPlayground.Float3Z", &playgroundFloat3Z, playgroundFloatMin, playgroundFloatMax, "gPlayground.Float3Z:%f")) {
    ...
    if (ImGui::SliderFloat("##gPlayground.Float4X", &playgroundFloat4X, playgroundFloatMin, playgroundFloatMax, "gPlayground.Float4X:%f")) {
    ...
    if (ImGui::SliderFloat("##gPlayground.Float4Y", &playgroundFloat4Y, playgroundFloatMin, playgroundFloatMax, "gPlayground.Float4Y:%f")) {
    ...
    if (ImGui::SliderFloat("##gPlayground.Float4Z", &playgroundFloat4Z, playgroundFloatMin, playgroundFloatMax, "gPlayground.Float4Z:%f")) {
